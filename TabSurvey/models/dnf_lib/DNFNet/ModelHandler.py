...
class ModelHandler:
    ...
    def define_placeholders(self):
        self.x = tf.compat.v1.placeholder(tf.float32, shape=[None, self.config['input_dim']], name="x")
        self.y = tf.compat.v1.placeholder(tf.float32, shape=[None, self.config['output_dim']], name="y")
        self.y_weights = tf.compat.v1.placeholder(tf.float32, shape=[None, 1], name="y_weights")
