...
class CICMalMem2022():
  ...
  def __init__(base_self, seed = SEED, print_able = True) -> None:
    ...
    base_self.__target_variable = "Category"
    base_self.__label_fts_names = ['Class', 'Category']
    ...
    base_self.__binary_map = {
        'Benign':                   'Benign',
        'Trojan-Refroso':           'Malicious',
        'Trojan-Scar':              'Malicious',
        'Trojan-Reconyc':           'Malicious',
        'Trojan-Zeus':              'Malicious',
        'Trojan-Emotet':            'Malicious',
        'Spyware-Transponder':      'Malicious',
        'Spyware-TIBS':             'Malicious',
        'Spyware-Gator':            'Malicious',
        'Spyware-180solutions':     'Malicious',
        'Spyware-CWS':              'Malicious',
        'Ransomware-Shade':         'Malicious',
        'Ransomware-Ako':           'Malicious',
        'Ransomware-Conti':         'Malicious',
        'Ransomware-Maze':          'Malicious',
        'Ransomware-Pysa':          'Malicious'
    }
  ...
  def __set_metadata(base_self) -> None:
    base_self.__ds_name = "CICMalMem2022"
    base_self.__ds_size = None
    base_self.__ds_fts = base_self.__fts_names
    base_self.__ds_label = base_self.__label_true_name
    base_self.__ds_paper_link = "https://www.unb.ca/cic/datasets/malmem-2022.html"
    base_self.__ds_link = "https://drive.usercontent.google.com/download?id=1Lz07kYeIi1UXmwhHL6f52gPc8sbZxp2D&export=download&authuser=1&confirm=t&uuid=1c61797e-da84-478d-accb-81d313132bd6&at=APZUnTWwHcF_VwigcmUU76mMjrgN:1695918496913"
