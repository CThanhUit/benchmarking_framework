...
class CICIDS2018():
  ...
  def __init__(base_self, seed = SEED, print_able = True) -> None:
    ...
    base_self.__real_cnt = {
      'Benign' : 13484708,'HOIC' : 686012,'LOIC-HTTP' : 576191,'LOIC-UDP' : 1730,
      'Hulk' : 461912,'SlowHTTPTest' : 139890,'GoldenEye' : 41508,'Slowloris' :10990,'Bot' : 286191,
      'FTP' : 193360,'SSH' : 187589,'Infilteration' : 161934,'BruteForce-Web' : 611,'BruteForce-XSS' : 230,'SQL-Injection' : 87
    ...
    'LOIC-UDP'          : "Malicious",
    'Hulk'              : "Malicious",
    'SlowHTTPTest'      : "Malicious",
    'GoldenEye'         : "Malicious",
    'Slowloris'         : "Malicious",
    'Bot'               : "Malicious",
    'FTP'               : "Malicious",
    'SSH'               : "Malicious",
    'Infilteration'     : "Malicious",
    'BruteForce-Web'    : "Malicious",
    'BruteForce-XSS'    : "Malicious",
    'SQL-Injection'     : "Malicious"
    }
    base_self.__label_true_name = [
      'Benign','HOIC', 'LOIC-HTTP', 'LOIC-UDP', 'Hulk', 'SlowHTTPTest', 'GoldenEye',
      'Slowloris', 'Bot', 'FTP', 'SSH', 'Infilteration', 'BruteForce-Web', 'BruteForce-XSS', 'SQL-Injection'

      ] # Map the actual label in the csv file with the label in the paper

    base_self.__label_drop = ['Label'] # List the label be dropped
  ...
  def __set_metadata(base_self) -> None:
    base_self.__ds_name = "CICIDS2018"
    base_self.__ds_size = None
    base_self.__ds_fts = base_self.__fts_names
    base_self.__ds_label = base_self.__label_true_name
    base_self.__ds_paper_link = "https://www.unb.ca/cic/datasets/ids-2018.html"
    base_self.__ds_link = "https://drive.usercontent.google.com/download?id=14mKey6EvYcZCVpvq7bUFrevQgikn32M1&export=download&authuser=1&confirm=t&uuid=da0258f8-c188-447e-9a09-7477645d7f4b&at=APZUnTVRRCucNSYnZApb31sUzpEX:1695972820074"
