...
class BoTIoT():
  ...
  def __init__(base_self, seed = SEED, print_able = True) -> None:
    ...
    base_self.__target_variable = "subcategory"
    base_self.__label_fts_names = ['attack','category','subcategory']
    base_self.__fts_names = [
      'pkSeqID','stime','flgs','proto','saddr','sport','daddr','dport','pkts','bytes','state','ltime',
    ...
    base_self.__binary_map = {
            'Normal':             'Normal', 
            'Keylogging':         'Malicious', 
            'Data_Exfiltration':  'Malicious', 
            'OS_Fingerprint':     'Malicious', 
            'Service_Scan':       'Malicious', 
            'TCP':                'Malicious', 
            'UDP':                'Malicious', 
            'HTTP':               'Malicious',
    }
    base_self.__label_true_name = [
      'Normal', 'TCP', 'UDP', 'HTTP', 'OS_Fingerprint', 'Service_Scan', 'Keylogging', 'Data_Exfiltration'
    ] # Map the actual label in the csv file with the label in the paper
  ...
  def __set_metadata(base_self) -> None:
    ...
    base_self.__ds_link = "https://drive.usercontent.google.com/download?id=1_z6xPJzLVwYueC_nOr3TPjUn7y2rQgJ_&export=download&authuser=1&confirm=t&uuid=8b6ca418-0e08-4626-aef3-253026c09ef7&at=APZUnTX1APQSogvT0HLXx5lACWaz:1717751433425"
