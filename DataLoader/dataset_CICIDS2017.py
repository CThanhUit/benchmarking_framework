...
class CICIDS2017():
  ...
  def __init__(base_self, seed = SEED, print_able = True) -> None:
    ...
    base_self.__real_cnt = {
        'BENIGN': 2273097, 'Hulk': 231073, 'PortScan': 158930, 'DDoS': 128027, 'GoldenEye': 10293,
    ...
    base_self.__label_true_name = [
      'BENIGN','Hulk', 'PortScan','DDoS','GoldenEye','FTP-Patator','SSH-Patator',
  ...
  def __set_metadata(base_self) -> None:
    base_self.__ds_name = "CICIDS2017"
